...
#ifndef INNER_PRODUCT_INTRINSIC_POWERPC_H
#define INNER_PRODUCT_INTRINSIC_POWERPC_H
...
void
fvec_inner_product_batch_4_ref_ippc (const float* x, const float* y0,
...
#endif /* INNER_PRODUCT_INTRINSIC_POWERPC_H */
